package pro.geektalk.key.framework.api;
...
public class RSArea {
	...
	public RSArea(MethodContext ctx) {
		this.ctx = ctx;
	}
	 ...
	 */
	public RSArea(final Tile t1, final Tile t2) {
	 ...
	 */
	public RSArea(final Tile... bounds) {
		polygon = new Polygon();
	...
	public Tile getNearest() {
		return getNearest(ctx.players.getLocal());
	}
